...
// const { getItemByUserId, addItem, deleteItem, getAllItems, editItem, getItemById } = require('../services/chatServices')
const { getItemByUserId, addItem } = require('../services/chatServices')
...
const getUserMessages = async (req, res) => { 
    if(authorizationLevel == 0 || authorizationLevel == 1){
        try{
            ...
            return res.status(200).render('chat', {messageCont, user: userId})
        } catch (error) {
...
//         const newMessage = {} 
//         newMessage.message = req.body
//         newMessage.user = req.session.passport.user

//         try{
//             const answer = await addItem(newMessage)
